...
const AssignedDetails = ({route, navigation}) => {
  ...
  useEffect(() => {
    if (job.item.status == "Assigned") {
      setButton("Set Active")
    }
    else if (job.item.status == "Active") {
      setButton("Set Completed")
    }
    else
      setDisplay("none")
  })
                  ...
                  <KeyboardAwareScrollView enableOnAndroid={true} enableAutomaticScroll={true} extraScrollHeight={150}>
                      ...
                      <View style={styles.row}>
                          <View style={styles.details}>
                              ...
                              <Text style={styles.subtitle}>{job.item.address1},</Text>
                              <Text style={styles.subtitle}>{job.item.address2}</Text>
                              <Text style={styles.subtitle}>{job.item.city}, {job.item.state} - {job.item.zip}</Text>
                          </View>
                      </View>
                      <View style={styles.row}>
